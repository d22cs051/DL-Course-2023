...
from lib.train.dataset import MSCOCOSeq, Got10k
# from lib.train.dataset import Lasot_lmdb, Got10k_lmdb, MSCOCOSeq_lmdb, ImagenetVID_lmdb, TrackingNet_lmdb
from lib.train.dataset import MSCOCOSeq_lmdb, Got10k_lmdb
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    datasets = []
    print(f"[INFO] name_list: {name_list}")
    for name in name_list:
        ...
        #         datasets.append(Got10k_lmdb(settings.env.got10k_lmdb_dir, split='train', image_loader=image_loader))
        #     else:
        ...
        #     if settings.use_lmdb:
        #         print("Building got10k from lmdb")
        #         datasets.append(Got10k_lmdb(settings.env.got10k_lmdb_dir, split='val', image_loader=image_loader))
        #     else:
        #         datasets.append(Got10k(settings.env.got10k_dir, split='val', image_loader=image_loader))
        ########################################################################################################################################        
